...
#define gms gms_na12
 double gms = 0.2;
#define hmin hmin_na12
 double hmin = 0.01;
#define mmin mmin_na12
 double mmin = 0.02;
...
#define vvh vvh_na12
 double vvh = -58;
#define vhalfs vhalfs_na12
 double vhalfs = -60;
#define zetas zetas_na12
 double zetas = 12;
 ...
 "qinf_na12", &qinf_na12,
 "vhalfs_na12", &vhalfs_na12,
 "a0s_na12", &a0s_na12,
 "zetas_na12", &zetas_na12,
 "gms_na12", &gms_na12,
 "smax_na12", &smax_na12,
 "vvh_na12", &vvh_na12,
 "vvs_na12", &vvs_na12,
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 na12 /Users/mollyleitner/Desktop/M1_PT/nbatch/mechanisms/na12.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/mollyleitner/Desktop/M1_PT/nbatch/mechanisms/na12.mod";
static const char* nmodl_file_text = 
  "TITLE na3\n"
  ": Na current \n"
