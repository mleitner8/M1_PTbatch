...
#define nrn_init _nrn_init__na16mut
#define _nrn_initial _nrn_initial__na16mut
#define nrn_cur _nrn_cur__na16mut
#define _nrn_current _nrn_current__na16mut
#define nrn_jacob _nrn_jacob__na16mut
#define nrn_state _nrn_state__na16mut
#define _net_receive _net_receive__na16mut 
#define states states__na16mut 
#define trates trates__na16mut 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_na16mut", _hoc_setdata,
 "alps_na16mut", _hoc_alps,
 "alpv_na16mut", _hoc_alpv,
 "bets_na16mut", _hoc_bets,
 "trap0_na16mut", _hoc_trap0,
 "trates_na16mut", _hoc_trates,
 0, 0
};
#define alps alps_na16mut
#define alpv alpv_na16mut
#define bets bets_na16mut
#define trap0 trap0_na16mut
...
#define Ena Ena_na16mut
 double Ena = 55;
#define Rd Rd_na16mut
 double Rd = 0.03;
#define Rg Rg_na16mut
 double Rg = 0.01;
#define Rb Rb_na16mut
 double Rb = 0.124;
#define Ra Ra_na16mut
 double Ra = 0.4;
#define a0s a0s_na16mut
 double a0s = 0.0003;
#define gms gms_na16mut
 double gms = 0.2;
#define hmin hmin_na16mut
 double hmin = 0.01;
#define mmin mmin_na16mut
 double mmin = 0.02;
#define qinf qinf_na16mut
 double qinf = 7;
#define qq qq_na16mut
 double qq = 10;
#define q10 q10_na16mut
 double q10 = 2;
#define qg qg_na16mut
 double qg = 1.5;
#define qd qd_na16mut
 double qd = 0.5;
#define qa qa_na16mut
 double qa = 7.2;
#define smax smax_na16mut
 double smax = 10;
#define sh sh_na16mut
 double sh = 8;
#define thinf thinf_na16mut
 double thinf = -55;
#define tq tq_na16mut
 double tq = -55;
#define thi2 thi2_na16mut
 double thi2 = -45;
#define thi1 thi1_na16mut
 double thi1 = -45;
#define tha tha_na16mut
 double tha = -35;
#define vvs vvs_na16mut
 double vvs = 2;
#define vvh vvh_na16mut
 double vvh = -58;
#define vhalfs vhalfs_na16mut
 double vhalfs = -60;
#define zetas zetas_na16mut
 double zetas = 12;
 ...
 "vvs_na16mut", "mV",
 "Ena_na16mut", "mV",
 "gbar_na16mut", "mho/cm2",
 "ar2_na16mut", "1",
 "ina_ina_na16mut", "mA/cm2",
 "thegna_na16mut", "mho/cm2",
 0,0
};
 ...
 "sh_na16mut", &sh_na16mut,
 "tha_na16mut", &tha_na16mut,
 "qa_na16mut", &qa_na16mut,
 "Ra_na16mut", &Ra_na16mut,
 "Rb_na16mut", &Rb_na16mut,
 "thi1_na16mut", &thi1_na16mut,
 "thi2_na16mut", &thi2_na16mut,
 "qd_na16mut", &qd_na16mut,
 "qg_na16mut", &qg_na16mut,
 "mmin_na16mut", &mmin_na16mut,
 "hmin_na16mut", &hmin_na16mut,
 "q10_na16mut", &q10_na16mut,
 "Rg_na16mut", &Rg_na16mut,
 "Rd_na16mut", &Rd_na16mut,
 "qq_na16mut", &qq_na16mut,
 "tq_na16mut", &tq_na16mut,
 "thinf_na16mut", &thinf_na16mut,
 "qinf_na16mut", &qinf_na16mut,
 "vhalfs_na16mut", &vhalfs_na16mut,
 "a0s_na16mut", &a0s_na16mut,
 "zetas_na16mut", &zetas_na16mut,
 "gms_na16mut", &gms_na16mut,
 "smax_na16mut", &smax_na16mut,
 "vvh_na16mut", &vvh_na16mut,
 "vvs_na16mut", &vvs_na16mut,
 "Ena_na16mut", &Ena_na16mut,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 na16mut /Users/mollyleitner/Desktop/M1_PT/nbatch/mechanisms/na16_mut.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/mollyleitner/Desktop/M1_PT/nbatch/mechanisms/na16_mut.mod";
static const char* nmodl_file_text = 
  "TITLE na3\n"
  ": Na current \n"
