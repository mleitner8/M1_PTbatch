...
#define gain _p[10]
#define gain_columnindex 10
#define rstim _p[11]
#define rstim_columnindex 11
#define tau1 _p[12]
#define tau1_columnindex 12
#define tau2 _p[13]
#define tau2_columnindex 13
#define e0 _p[14]
#define e0_columnindex 14
#define vo0 _p[15]
#define vo0_columnindex 15
#define vi0 _p[16]
#define vi0_columnindex 16
#define fac _p[17]
#define fac_columnindex 17
#define i _p[18]
#define i_columnindex 18
#define e _p[19]
#define e_columnindex 19
#define vo _p[20]
#define vo_columnindex 20
#define vi _p[21]
#define vi_columnindex 21
#define stim _p[22]
#define stim_columnindex 22
#define tc _p[23]
#define tc_columnindex 23
#define De _p[24]
#define De_columnindex 24
#define Dvo _p[25]
#define Dvo_columnindex 25
#define Dvi _p[26]
#define Dvi_columnindex 26
#define _g _p[27]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 1, "pntproc");
 	...
 	ivoc_help("help ?1 VClamp_plus /Users/mollyleitner/Desktop/M1_PT/nbatch/mechanisms/vclmp_pl.mod\n");
...
double icur (  ) {
 ...
 if(error){fprintf(stderr,"at line 148 in file vclmp_pl.mod:\n		SOLVE clamp\n"); nrn_complain(_p); abort_run(error);}
 _licur = ( vo - v ) / rstim ;
     }
...
{
 { error =  update();
 if(error){fprintf(stderr,"at line 118 in file vclmp_pl.mod:\n	SOLVE update METHOD after_cvode : but not really (see above)\n"); nrn_complain(_p); abort_run(error);}
 }}}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/mollyleitner/Desktop/M1_PT/nbatch/mechanisms/vclmp_pl.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
  "\n"
  "A five-state markovian kinetic model of ionic channel Nav1.5.\n"
  "Part of a study on kinetic models.\n"
  "Author: Emilio Andreozzi, 2019\n"
  "Modifed : Emily Nguyen, January 2020 \n"
  "Na v1.2 ionic voltage-gated channel.\n"
  "\n"
  "Voltage clamp with \"five\" levels. Clamp is on at time 0, and off at time\n"
