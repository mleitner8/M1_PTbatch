...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 K_Tst /ddn/jchen/dev/M1_PT/Neuron_Model_HH/mechanisms/K_Tst.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/ddn/jchen/dev/M1_PT/Neuron_Model_HH/mechanisms/K_Tst.mod";
static const char* nmodl_file_text = 
