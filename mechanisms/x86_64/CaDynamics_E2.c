...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 CaDynamics_E2 /ddn/jchen/dev/M1_PT/Neuron_Model_HH/mechanisms/CaDynamics_E2.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/ddn/jchen/dev/M1_PT/Neuron_Model_HH/mechanisms/CaDynamics_E2.mod";
static const char* nmodl_file_text = 
