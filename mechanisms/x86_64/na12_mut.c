...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 na12mut /ddn/jchen/dev/M1_PT/Neuron_Model_HH/mechanisms/na12_mut.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/ddn/jchen/dev/M1_PT/Neuron_Model_HH/mechanisms/na12_mut.mod";
static const char* nmodl_file_text = 
  "TITLE na3\n"
  ": Na current \n"
